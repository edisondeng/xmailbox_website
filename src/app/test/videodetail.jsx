...
function Video_detail({onClose, num, title, description, icon, next, previous, onNextClicked, onPreviousClicked, children}){
  return (
    <div className="">
      ...
      >
        <div className="w-3/5 h-4/5 flex flex-col rounded-lg bg-gradient-to-b from-blue-50 to-blue-100 p-3 mx-auto shadow-2xl">
          ...
          <div className="flex flex-row h-full mt-6 gap-10 items-start justify-aroun">
            ...
            <div className="md:text-xl mt-6 px-10 w-1/3 h-full flex flex-col items-start wavy-background-small">
